export const en = {
  ...
  'apiKeys.description':
    'Create personal API keys for programmatic access to your account. Keep them secret -- anyone with a key can act as you within its granted scope.',
  'apiKeys.empty': 'No API keys yet.',
  'apiKeys.loadFailed': 'Failed to load API keys',
  'apiKeys.columnName': 'Name',
  'apiKeys.columnPrefix': 'Prefix',
  'apiKeys.columnScopes': 'Scopes',
  ...
  'apiKeys.revokeFailed': 'Failed to revoke API key',
  'apiKeys.createButton': 'Create API Key',
  'apiKeys.nameLabel': 'Name',
  'apiKeys.namePlaceholder': 'e.g. Music Assistant',
  'apiKeys.scopeRead': 'Read',
  'apiKeys.scopeWrite': 'Write',
  'apiKeys.scopeAdmin': 'Admin',
  'apiKeys.creating': 'Creating...',
  'apiKeys.createSuccess': 'API key created',
  'apiKeys.createFailed': 'Failed to create API key',
  'apiKeys.tokenLabel': 'Your new API key',
  'apiKeys.tokenWarning':
    "For security, this key won't be shown again after you close this dialog. Copy it now.",
  'apiKeys.copyToken': 'Copy API key',
  'apiKeys.tokenCopied': 'Copied to clipboard',
  'apiKeys.done': 'Done',
  ...
  'discoveryMode.critically-acclaimed.label': 'Critically Acclaimed',
  'discoveryMode.critically-acclaimed.description':
    'Highly rated albums from your review sources that you do not own yet',
